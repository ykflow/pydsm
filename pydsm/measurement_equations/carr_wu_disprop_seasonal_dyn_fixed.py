...
def carr_wu_disprop_seasonal_dyn_fxd(f, FIXED, betas, p, m):
    x, tau, T, Z = FIXED
    kappa1, omega1_star, nu_star, rho_star, eta1_tilde, eta2_tilde = f.flatten()
...
class CarrWuDisPropSeasonalDynamicFixed:
    def __init__(self, mean:str = 'carr_wu_disprop_s1_dyn_fixed'):
        self.mean = mean
        self.Zf = carr_wu_disprop_seasonal_dyn_fxd
        self.J = None #jac_carr_wu_disprop_seasonal_fxd
        self._dict_means = dict({'carr_wu_disprop_s1_dyn_fixed':2, 'carr_wu_disprop_s2_dyn_fixed':4,
                                 'carr_wu_disprop_s3_dyn_fixed':6, 'carr_wu_disprop_s4_dyn_fixed':8})
        self.k_fxd = 4 + 2
        self.k_free = 0
