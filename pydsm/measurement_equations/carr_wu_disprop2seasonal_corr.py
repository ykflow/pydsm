...
def carr_wu_disprop_seasonal_corr(f, FIXED, betas, p, m):
    x, tau, T, Z = FIXED
    eta1_tilde, eta2_tilde, eta3_tilde, kappa1, omega1_star, nu_star, rho1_star = f.flatten()[:7]
...
class CarrWuDisPropSeasonalCorr:
    def __init__(self, mean:str = 'carr_wu_disprop_s1_corr'):
        self.mean = mean
        self.Zf = carr_wu_disprop_seasonal_corr
        self.J = None #jac_carr_wu_disprop_seasonal_fxd
        self._dict_means = dict({'carr_wu_disprop_s1_corr':2, 'carr_wu_disprop_s2_corr':4,
                                 'carr_wu_disprop_s3_corr':6, 'carr_wu_disprop_s4_corr':8})
