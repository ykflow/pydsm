...
def carr_wu_disprop_seasonal_prop_volcorr(f, FIXED, betas, p, m):
    x, tau, T, Z = FIXED
    kappa1, omega1_star, nu1_star, rho1_star, eta1_tilde, eta2_tilde, eta3_tilde = f.flatten()[:7]
...
class CarrWuDisPropSeasonalPropVolCorr:
    def __init__(self, mean:str = 'carr_wu_disprop_s1_prop_volcorr'):
        self.mean = mean
        self.Zf = carr_wu_disprop_seasonal_prop_volcorr
        self.J = None #jac_carr_wu_disprop_seasonal_fxd
        self._dict_means = dict({'carr_wu_disprop_s1_prop_volcorr':2, 'carr_wu_disprop_s2_prop_volcorr':4,
                                 'carr_wu_disprop_s3_prop_volcorr':6, 'carr_wu_disprop_s4_prop_volcorr':8})
        self.k_fxd = 4 + 3 + self._dict_means[self.mean]
        self.k_free = 0
        self.k_betas_free = 0
        self.k_betas_pos = 0
        self._test_jac()
