...
def carr_wu_seasonal_decay_kappa(f, FIXED, betas, p, m):
    x, tau, T, Z = FIXED
    kappa1, omega_star, nu_star, rho_star, eta1_star, eta2_star = f.flatten()[:6]
    deltas = f[6:]
...
class CarrWuSeasonalDecayKappa:
    def __init__(self, mean:str = 'carr_wu_s1_decay_kappa'):
        self.mean = mean
        self.Zf = carr_wu_seasonal_decay_kappa
