...
def carr_wu_disprop2_seasonal_knots(f, FIXED, betas, p, m):
    x, tau, T, Z = FIXED
...
class CarrWuDisProp2SKnots:
    def __init__(self, mean:str = 'carr_wu_disprop2_sknots'):
        self.mean = mean
        self.Zf = carr_wu_disprop2_seasonal_knots
