...
def carr_wu_disprop2_seasonal_corr(f, FIXED, betas, p, m):
    x, tau, T, Z = FIXED
    kappa1, omega1_star, nu_star, rho1_star, eta1_tilde, eta2_tilde, eta3_tilde = f.flatten()[:7]
    omega1, nu, rho1, gamma = map_moments(omega1_star, nu_star, rho1_star)
    deltas = f[7:]
...
class CarrWuDisProp2SeasonalCorr:
    def __init__(self, mean:str = 'carr_wu_disprop2_s1_corr'):
        self.mean = mean
        self.Zf = carr_wu_disprop2_seasonal_corr
        self.J = None #jac_carr_wu_disprop_seasonal_fxd
        self._dict_means = dict({'carr_wu_disprop2_s1_corr':2, 'carr_wu_disprop2_s2_corr':4,
                                 'carr_wu_disprop2_s3_corr':6, 'carr_wu_disprop2_s4_corr':8})
