...
def carr_wu_disprop_seasonal(f, FIXED, betas, p, m):
    x, tau, T, Z = FIXED
...
class CarrWuDisPropSeasonal:
    def __init__(self, mean:str = 'carr_wu_disprop_s1'):
        self.mean = mean
        self.Zf = carr_wu_disprop_seasonal
        self.J = None #jac_carr_wu_disprop_seasonal_fxd
        self._dict_means = dict({'carr_wu_disprop_s1':2, 'carr_wu_disprop_s2':4,
                                 'carr_wu_disprop_s3':6, 'carr_wu_disprop_s4':8})
